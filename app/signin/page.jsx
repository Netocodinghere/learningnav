...
const SignUp = () => {
  ...
  <div className="w-full max-w-md bg-white/10 backdrop-blur-md rounded-2xl shadow-2xl p-8 flex flex-col items-center border border-white/20">
    ...
    <h1 className="text-3xl font-extrabold text-white text-center mb-2 drop-shadow">Your AI-Powered <span className="text-cyan-400">Study Companion</span></h1>
    <form onSubmit={handleSubmit} className="flex flex-col gap-4 w-full">
      ...
      <input
        ...
        className="px-4 py-3 rounded-lg bg-white/20 text-white placeholder-white/60 focus:outline-none focus:ring-2 focus:ring-cyan-400 transition"
      />
      <button type="submit" className="w-full py-3 mt-2 rounded-lg bg-cyan-500 text-white font-bold shadow hover:bg-cyan-400 transition">
        Sign Up →
      </button>
    </form>
