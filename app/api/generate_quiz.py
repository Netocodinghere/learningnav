...
async def generate_quiz(
    ...
    if file:
        ...
        return JSONResponse(status_code=400, content={"error": "Provide either a file or text input"})

    questions = generate_questions(chunks, number=number)
