...
const Nav = () => {
  return (
    ...
    <span className="font-extrabold text-xl self-center inline-flex  items-center justify-center text-gray-50 lg:text-3xl"> 
    
      <span>LearnNav</span>     
      <img src="/oip.png" alt="Pencil Holder" layout="fill" objectFit="contain" className=" lg:size-16 size-12   bg-white rounded-full ml-1" />
